...
const Testimonials = () => {
  const testimonials = [
    {
      text: "Amazing service! The best bookstore in town.",
      author: "John Doe",
    },
    {
      text: "A wide variety of books. I always find what I need.",
      author: "Jane Smith",
    },
        ...
        >
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="h6" sx={{ marginBottom: "20px" }}>
              Explore a vast collection of books curated just for you. Find the
              perfect read for every mood and occasion.
            </Typography>
            <Button
              component={Link}
              to="/books"
